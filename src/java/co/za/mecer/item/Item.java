...
public class Item implements Serializable {
    ...
    public Item(int Item_Id, int ItemDiscount_Id, int Category_Id, int Recipe_Id, String Item_Name, int quantity, double Price, String Allegens, String Desription) {
    ...
    public Item(int Item_Id, String Item_Name, int quantity, double Price, String Allegens, String Desription) {
        this.Item_Id = Item_Id;
        this.Item_Name = Item_Name;
        this.quantity = quantity;
        this.Price = Price;
